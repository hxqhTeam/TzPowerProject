package hqxh.tzpowerproject.view.widght;
...
import hqxh.tzpowerproject.adapter.ApprovalAdapter;
...
public class ConfirmDialog extends Dialog {
    ...
    public static class Builder {
        ...
        private List<Approve> results; //意见选项
        ...
        public Builder setData(List<Approve> result) {
            this.results = result;
            return this;
        }
